...
1220 GOSUB 30
1230 IF CC<2 OR CC>NI THEN P=P+B(H) ELSE TC=TC+CC:N=N+1
1240 GOTO 1210
1250 IF N=0 THEN 1530
1260 C=TC/N:CC=0
1500 H0=I
1505 CALL &0020:REM NMI OFF
1510 V0=95-J:GOSUB 2000
1520 V0=95+J:GOSUB 2000
1525 CALL &0028:REM NMI ON
1530 NEXT I
...
2010 PUT 191,BL:PUT 191,BH+64
2020 PUT 190,P
2030 PUT 191,BL:PUT 191,BH+96
2040 PUT 190,PA(CC)*16+PA(C)
2050 RETURN
8000 REM ****************
